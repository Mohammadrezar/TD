...
if matches[1] == 'setlang' or matches[1] =='نشاندن زبان' and  matches[2] == 'en' or matches[2] =='نشاندن انگلیسی' and is_owner(msg) then 
...
if matches[1] == 'setlang' or matches[1] =='نشاندن زبان' and matches[2] == 'fa' or matches[2] =='نشاندن فارسی' and is_owner(msg) then
redis:hset(hash,'lang',matches[2])
        return 'زبان گروه تنظیم شد به : FA'
end
if matches[1] == 'lang' or matches[1] =='زبان' then
if group_lang then 
